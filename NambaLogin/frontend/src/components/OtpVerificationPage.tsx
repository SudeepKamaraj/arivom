...
export default function OtpVerificationPage({ navigate, email, isSignup, onLogin }: OtpVerificationPageProps) {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const endpoint = isSignup ? 'http://localhost:5000/api/auth/signup/verify-otp' : 'http://localhost:5000/api/auth/verify-otp';
